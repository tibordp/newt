...
pub fn default_commands() -> Vec<CommandDef> {
    conditional_vec![
        ...
        CommandDef {
            id: "directory_properties".into(),
            name: "Directory Properties...".into(),
            short_name: None,
            category: "File".into(),
            default_keys: vec![],
            default_when: Some("pane_focused".into()),
        ...
        CommandDef {
            ...
            short_name: Some("Open in Term".into()),
        ...
        CommandDef {
            ...
            short_name: Some("Focus Term".into()),
            category: "Terminal".into(),
        ...
        CommandDef {
            id: "open_config_file".into(),
            name: "Open Settings File in Editor".into(),
            short_name: None,
            category: "File".into(),
            default_keys: vec![],
            default_when: None,
